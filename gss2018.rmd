...
```
This chart ultimately shows that level of schooling DOES have an affect on the WORDSUM test percentage results 
...
```
The numerical results show that in 2012 those who did vote had almost 16 years of education. 
...
```
The family confidence levels 
There is no difference between high school and junior college. However there s a difference between high school, bachelors, and graduates. 
...
This summary result and the inferential results have shown that they are not independent.
